...
public class Main {
    public static void main(String[] args) {
        ...
        imam.setName("Imam Solehudin");
        imam.setAddress("Perum BCA Blok. E5 No. 30");
        ...
        Cash cash = new Cash();
        cash.setCashTendered((float) 10000.0);
        ...
        check.setName("Imam Solehudin");
        check.setBankID("7896541230");
        check.authorized();
